...
# filter to horizontal or vertical segments
segments = [s for s in segments if s.is_horizontal_or_vertical()]

# Map the ocean floor based on the remaining segments
